...
first_day_of_month = datetime.now(pytz.timezone(time_local)).replace(day=1, hour=0, minute=0, second=0, microsecond=0)
start_posix = to_posix(first_day_of_month)
